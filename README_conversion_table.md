...
|----|----------|-------------|------------| ----- | --------- |
| 1  | Square (note head)                              | lowercase characters <br/>from `a` to `m` | `<nc>` | <img src="images/square_punctum.jpg" width="75"> <img src="images/punctum_AQ.jpg" width="75"/> | <img src="images/verovio_punctum.png" height="75"> |
| 2  | Rhombus                                         | uppercase characters <br/>from `A` to `M`   | `<nc`**`tilt="se"`**`/>` | <img src="images/stemright_rhombus.jpg" width="150"> <img src="images/clivis_rhombusbelow_AQ.jpg" width="75"> | <img src="images/verovio_rhombus.png" height="75"> |
| 3  | Downward stem                                   | `V` or `v` | `<nc>` with `@tilt=n` (`ne`) or `@tilt=s` |||
| 3a  | Downward stem _left side of note_              | `V` | `<nc`**`tilt="n"`**`/>` (Square notation) <br/>`<nc`**`tilt="ne"`**`/>` (Aquitanian notation) | <img src="images/clivis(stemleft).jpg" width="75"> <img src="images/pes_AQ.jpg" width="75"> | <img src="images/verovio_stemleft.png" height="75"> |
| 3b  | Downward stem _right side of note_             | `v` | `<nc`**`tilt="s"`**`/>` | <img src="images/stemright_rhombus.jpg" width="150"> <img src="images/stemright_AQ.jpg" width="75"> | <img src="images/verovio_stemright.png" height="75"> |
| 4   | Liquescent (indicating a lower note)            | `>` | `<nc`**`curve="c"`**`>`<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<liquescent/>`**<br/>`</nc>` |||
| 4a  | Cephalicus _with downward stem at the left_      | `>V` | `<nc`**`curve="c" tilt="n" type="cephalicus"`**`>`<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<liquescent/>`**<br/>`</nc>`<br/> (Or `@tilt=ne` in Aquitanian notation) | <img src="images/cephalicus.jpg" width="75"> <img alt="cephalicusNE_AQ" src="images/cephalicusNE_AQ.png" width="75"> | <img src="images/smufl_chant-cephalicus.png" height="75"> |
| 4b  | Cephalicus _with downward stem at the right_     | `>v` | `<nc`**`curve="c" tilt="s" type="cephalicus"`**`>`<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<liquescent/>`**<br/>`</nc>`<br/> (Only in Aquitanian notation, and always preceded by a rhombus) | <images src="images/cephalicusS2.png" height="75"> | ? |
| 5  | Liquescent (indicating a higher note) / Epiphonus | `<` | `<nc`**`curve="a" type="epiphonus"`**`>`<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<liquescent/>`**<br/>`</nc>` | <img src="images/epiphonus_AQ.jpg" width="75"> | <img src="images/smufl_chant-epiphonus.png" height="75"> |
| 6  | Oriscus                                         | `o` | `<nc>`<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<oriscus/>`**<br/>`</nc>`  | <img src="images/oriscus_AQ.jpg" width="75"> | <img src="images/verovio_oriscus.png" height="75"> |
| 7  | Quilisma                                        | `w` | `<nc>`<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<quilisma/>`**<br/>`</nc>` | <img src="images/quilisma_AQ2.jpg" width="75"> | <img src="images/verovio_quilisma.png" height="75"> |
...
| 9a | Square with two stems down | `9` | `<neume`**`type="twolegsdown">`**<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<nc @same-pitch/>`**<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<nc @same-pitch/>`**<br/>`</neume>` | <img src="images/twostemsdown.png" width="75"> | <img src="images/verovio_repeated.png" height="75"> |
| 9b | Square with two stems up | `6` | `<neume`**`type="twolegsup">`**<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<nc @same-pitch/>`**<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<nc @same-pitch/>`**<br/>`</neume>` |  ?  | <img src="images/verovio_repeated.png" height="75"> |
...
| 10a | Lengüeta with two stems down | `*9` | `<neume`**`type="lenguetadown">`**<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<nc @same-pitch/>`**<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<nc @same-pitch/>`**<br/>`</neume>` | <img src="images/lenguetadown.png" width="75"> | <img src="images/verovio_repeated.png" height="75"> |
| 10b | Lengüeta with two stems up | `*6` | `<neume`**`type="lenguetaup">`**<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<nc @same-pitch/>`**<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<nc @same-pitch/>`**<br/>`</neume>` | <img src="images/lenguetaup.png" width="75"> | <img src="images/verovio_repeated.png" height="75"> |
| 11 | Obliqua                     | `º` preceding first neume <br/>component of the two[^1] | `<nc`**`ligated="true"`**`/>`<br/>`<nc`**`ligated="true"`**`/>`| <img src="images/obliqua_stemleft.jpg" width="75"> <img src="images/obliqueInTheMiddle.jpg" width="75"> | <img src="images/verovio_obliqua.png" height="75"> |

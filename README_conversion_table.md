...
| 4a  | Cephalicus _with downward stem at the left_      | `>V` | `<nc`**`curve="c" tilt="n" type="cephalicus"`**`>`<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<liquescent/>`**<br/>`</nc>`<br/> (Or `@tilt=ne` in Aquitanian notation) | <img src="images/cephalicus.jpg" width="60"> <img alt="cephalicusNE_AQ" src="images/cephalicusNE_AQ.png" width="60"> | <img src="images/smufl_chant-cephalicus.png" height="75"> |
...
| 5  | Liquescent (indicating a higher note) / Epiphonus | `<` | `<nc`**`curve="a" type="epiphonus"`**`>`<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<liquescent/>`**<br/>`</nc>` | <img src="images/epiphonus_AQ.jpg" width="60"> | <img src="images/smufl_chant-epiphonus.png" height="75"> |

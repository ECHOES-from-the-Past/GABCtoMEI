...
|----|----------|-------------|------------| ----- |
| 1  | Square (note head)                              | lowercase characters <br/>from `a` to `m` | `<nc>` | ![square_punctum](https://github.com/user-attachments/assets/47bf2476-bb5f-4646-af28-ef3d514fac62) ![punctum_AQ](https://github.com/user-attachments/assets/e6a2f1bd-99fb-452d-9dfd-cf955b4b4a81) |

...
| 4b  | Cephalicus _with downward stem at the right_     | `>v`<br/>(or `v>`) | `<nc`**`curve="c" tilt="s" type="cephalicus"`**`>`<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<liquescent/>`**<br/>`</nc>`<br/> (Only in Aquitanian notation) | <img src="images/cephalicusS2.png" height="75"> | <img src="images/smufl_chant-cephalicus.png" height="50"><br/>to be implemented |

...
| 4b  | Cephalicus _with downward stem at the right_     | `>v` | `<nc`**`curve="c" tilt="s" type="cephalicus"`**`>`<br/>&nbsp;&nbsp;&nbsp;&nbsp;**`<liquescent/>`**<br/>`</nc>`<br/> (Only in Aquitanian notation, and always preceded by a rhombus) | <img src="images/cephalicusS2.png" height="75"> | ? |

...
| 13a | Flat     | `x` | `<accid`**`accid="f"`**`/>` | <img src="images/flat_square.png" width="60"> | <img src="images/verovio_flat.png" width="60"> |
| 13b | Natural  | `y` | `<accid`**`accid="n"`**`/>` | no examples in our corpus | <img src="images/verovio_natural.png" width="60"> |
| 13c | Sharp    | `#` | `<accid`**`accid="s"`**`/>` | no examples in our corpus | <img src="images/verovio_sharp.png" width="60"> |
